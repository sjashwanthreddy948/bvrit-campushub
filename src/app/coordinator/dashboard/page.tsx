  ...
  return (
    <DashboardShell role="coordinator" userName="Dr. Lakshmi (Placement Officer)">
      <div className="space-y-6 pb-12 max-w-7xl mx-auto">
        {/* Illustrated TPO Header Banner in Liquid Glass */}
        <div className="w-full rounded-3xl liquid-glass-card p-6 sm:p-8 relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="space-y-3 flex-1 min-w-0 relative z-10">
            <div className="flex items-center gap-2 flex-wrap">
              <Badge variant="amber">TPO Placement Cell</Badge>
              <Badge variant="powder">BVRIT Narsapur • Autonomous</Badge>
            ...
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight text-slate-900 dark:text-slate-100 leading-tight">
              Placement &amp; Career Coordination Hub <span className="text-[#F59E0B]">✦</span>
            </h1>
            ...
            <div className="pt-2 flex flex-wrap items-center gap-2">
              <Link href="/coordinator/opportunities/new">
                <Button variant="amber-glow" size="sm" leftIcon={<Plus className="h-4 w-4" />}>
                  New Placement Drive
                </Button>
              </Link>
            </div>
          ...
          <div className="shrink-0 max-w-[240px] hidden md:block relative z-10">
        ...
        <div className="p-4 sm:p-5 rounded-3xl bg-white dark:bg-[#1B1C22] border border-[#F0E4E2] dark:border-[#2B2C35] flex flex-col gap-4 shadow-xs">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            <div className="relative flex-1 w-full">
              ...
              <input
                ...
                className="w-full pl-9 pr-4 py-2.5 text-sm rounded-2xl border border-[#F0E4E2] dark:border-[#2B2C35] bg-white dark:bg-[#1B1C22] focus:outline-none focus:ring-2 focus:ring-[#F59E0B]"
              />
            </div>
          </div>

          {/* Branch & Section Filtering */}
          <div className="space-y-2 pt-2 border-t border-[#F0E4E2] dark:border-[#2B2C35]">
